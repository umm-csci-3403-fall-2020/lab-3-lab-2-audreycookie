...
int* array_merge(int num_arrays, int* sizes, int** values) {
  ...
  int* fullArray;
  for (int i = 0; i < sizesIndex; ++i){ //the number of all the values in the values array with repeats
  ...
  for (int i = 0; i < sizesIndex; ++i) { //looping through the elements of sizes
